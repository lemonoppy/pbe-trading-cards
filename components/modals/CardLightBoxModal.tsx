              ...
              >
                ...
                >
                  ...
                  <Box
                    ...
                    rounded="md"
                    boxShadow="lg"
                    overflow={!isFlipped ? 'hidden' : 'auto'}
                    style={{
                      backfaceVisibility: 'hidden',
            ...
            <div>
              {cardMakerInfo
                ? cardMakerInfo?.map((info) => (
                    <div key={info.userid} className="text-sm font-normal">
                      Artist: {info.username}
                    </div>
                  ))
                : null}
              {cardMakerInfo &&
              cardMakerInfo[0] &&
              cardMakerInfo[0].date_approved &&
              cardMakerInfo[0].date_approved !== 'null' ? (
                <div className="text-sm font-normal">
                  Date Approved:{' '}
                  {new Date(cardMakerInfo[0].date_approved).toLocaleDateString()}
                </div>
              ) : (
                <div className="text-sm font-normal">Date Approved: None Recorded</div>
              )}
            </div>
          </DrawerHeader>
