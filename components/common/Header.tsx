...
const externalLinks = [
  {
    name: 'Forums',
    href: 'https://forums.pbe.simflow.io',
  },
  {
    name: 'Portal',
    href: 'https://portal.pbe.simflow.io/',
  },
  {
    name: 'Index',
    href: 'https://index.pbe.simflow.io/',
  },
]
      ...
      <div className="z-50 h-16 w-full bg-black text-secondary">
        <div className="relative mx-auto flex h-full w-full items-center justify-between px-[5%] sm:w-11/12 sm:justify-start sm:p-0 lg:w-3/4">
          ...
          >
            <div
              onClick={() => router.push('/')}
              className="cursor-pointer transition-all h-full flex items-center"
            >
              <DottsLogo aria-label="Dotts Homepage" width={64} height={64} />
            </div>
          </Link>
          <div
              ...
              <Menu isLazy>
                {({ isOpen }) => (
                  <>
                    ...
                    <MenuList>
                      <RoleGuard
                        userRoles={['PORTAL_MANAGEMENT', 'DOTTS_ADMIN', 'DOTTS_TEAM']}
                      >
                        <MenuItem
                          className="hover:!bg-highlighted/40 hover:!text-primary"
                      ...
                      <RoleGuard userRoles={['PORTAL_MANAGEMENT', 'DOTTS_ADMIN']}>
                        <MenuItem
                          className="hover:!bg-highlighted/40 hover:!text-primary"
