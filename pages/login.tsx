      ...
      <div className="mx-auto w-full bg-primary space-y-4 px-12 py-20 2xl:w-3/5 2xl:px-28">
        <div className="mx-auto flex min-h-[calc(100vh-16rem)] flex-col text-center md:w-3/5">
          ...
          <div className="text-sm">
            <Link
              isExternal
              href="https://forums.pbe.simflow.io/member.php?action=lostpw"
          ...
          <div className="font-mont text-sm">
            ...
            <Link
              isExternal
              href="https://forums.pbe.simflow.io/member.php?action=register"
              className=" !text-link"
            >
              Sign up
            </Link>
